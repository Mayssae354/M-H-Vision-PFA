...
* The original package name 'com.smartvision.smartvision-backend' is invalid and this project uses 'com.smartvision.smartvision_backend' instead.
...
* [Quartz Scheduler](https://docs.spring.io/spring-boot/3.5.11/reference/io/quartz.html)
